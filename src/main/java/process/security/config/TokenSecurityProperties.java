package process.security.config;
...
public class TokenSecurityProperties {
    ...
    public static long REMEMBER_EXPIRATION_TIME =  999_999_999; // 11.57 days
    public static long SESSION_EXPIRATION_TIME =  86_400_000; // 1 day
    public static long BEARER_EXPIRATION_TIME =  999_999_999; // 11.57 days
